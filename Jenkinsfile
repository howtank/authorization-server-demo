pipeline {
    ...
    stages {
        ...
        //                     sh label: 'Stop container', script: "cd ${DOCKER_CONFIG} && sudo /usr/local/bin/docker-compose stop oauth"
        //                     }

        //                 stage ('Starting container') {
        //                     sh 'cd ${DOCKER_CONFIG} && sudo /usr/local/bin/docker-compose build oauth'
        //                     sh 'cd ${DOCKER_CONFIG} && sudo /usr/local/bin/docker-compose up -d oauth'
        //                 }
        //             }
